...
Add-Content $logFile -Encoding UTF8 "Run started at $(Get-Date)"

Write-Output "Starting CBM process..."

# Step 1: Collect status
Add-Content $logFile -Encoding UTF8 "Running collect_status.ps1..."
...
Add-Content $logFile -Encoding UTF8 "Collect completed."

# Step 2: Auto push
Add-Content $logFile -Encoding UTF8 "Running auto_push.ps1..."
powershell -ExecutionPolicy Bypass -File "C:\cbm-dashboard\auto_push.ps1" 2>&1 | Tee-Object -FilePath $logFile -Append

Add-Content $logFile -Encoding UTF8 "Push completed."
Add-Content $logFile -Encoding UTF8 "Run finished at $(Get-Date)"
Add-Content $logFile -Encoding UTF8 "==============================="
